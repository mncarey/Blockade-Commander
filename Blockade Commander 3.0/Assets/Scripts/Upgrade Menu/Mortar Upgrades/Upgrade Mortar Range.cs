...
public class UpgradeMortarRange : MonoBehaviour
{
    ...
    public void IWasClicked()
    {
        ...
        {
            Debug.Log("not enough gold to upgrade mortar range :( ");
        ...
        //update health
        resourceUIRef.mortarRangeUpgrade++;
        ...
        Debug.Log($"Upgrade mortar range +1 for {upgradeManagerRef.mortarPrice} gold (now level {upgradeManagerRef.upgradeLvlMortar})");
        ...
        {
            mortar.ApplyHealthUpgrade(resourceUIRef.mortarRangeUpgrade);
        }
    }
}
